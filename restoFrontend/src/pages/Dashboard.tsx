        ...
        <main className="main">
          <nav className="sidebar">
            ...
            <div className="links">
              ...
              <Link to="menu-item" className="link" onClick={handleFocus}>
            ...
            <div className="header">
              ...
              <div className="user">
                <span className="user__name">{user.name}</span>
                    ...
                    {theme !== "light" ? (
              <Sun style={{marginLeft:'5px'}} className="theme" onClick={() => setTheme("light")} />
            ) : (
              <Moon style={{marginLeft:'5px'}} className="theme" onClick={() => setTheme("dark")} />
            )}
              </div>
            </div>
