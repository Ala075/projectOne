    ...
    const storedData = async () => {
      ...
      if (storedProducts) {
        ...
        try {
          ...
          localStorage.setItem("products", JSON.stringify(res.data.itemsMenu));
        } catch (error) {
          console.log(error);
        }
      }
    ...
    <div className="main__dashboard">
      <div className="container__left">
        ...
        <div className="categories__dashboard">
          <div className="categories__dashboard__container">
            <div className="categories__dashboard_title">
              <h2>Categories</h2>
              <span>See All</span>
            </div>
        ...
        <div className="categories__dashboard" style={{ color: "black" }}>
          <div className="categories__dashboard__container">
            <div className="products__dashboard_title">
              <h2>Products</h2>
              <span>See All</span>
            </div>
