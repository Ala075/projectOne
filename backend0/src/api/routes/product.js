...
productRouter.post('/', requireAuth, uploadArray, productController.createProduct);
productRouter.patch('/:id', requireAuth, uploadArray, productController.updateProductById);
